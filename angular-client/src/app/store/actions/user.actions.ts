...
import { ACTION_USER_CREATE_USER,
    ...
    ACTION_USER_GET_ATTENDANTS, ACTION_USER_GET_ATTENDANTS_SUCCESS, ACTION_USER_GET_ATTENDANTS_ERROR
...
export const getAttendants = createAction(ACTION_USER_GET_ATTENDANTS);
export const getAttendantsSuccess = createAction(ACTION_USER_GET_ATTENDANTS_SUCCESS, props<{attendants: Attendant[]}>());
export const getAttendantsError = createAction(ACTION_USER_GET_ATTENDANTS_ERROR, props<{error: any}>());
