/* User actions */
export const ACTION_USER_GET_MEETINGS = '[User] get meetings';
export const ACTION_USER_GET_MEETINGS_SUCCESS = '[User] get meetings success';
export const ACTION_USER_GET_MEETINGS_ERROR = '[User] get meetings error';
